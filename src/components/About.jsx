    ...
    <div id="about">
      <div className="px-4 w-screen md:py-32 md:w-[80%] mx-auto sm:mt-16 mt-[200px]">
        ...
        <p className="max-w-4xl sm:text-xl mx-auto text-center text-slate-600">
          At Pristine Home Cleaning, we are dedicated to providing exceptional cleaning services
          that transform your home into a haven of cleanliness and comfort. Our team of skilled and
          passionate professionals takes pride in every detail, ensuring a spotless and organized
        ...
        <p className="max-w-4xl sm:text-xl mx-auto mt-6 text-center text-slate-600">
          ...
          services are tailored to meet your unique requirements. We take care of every space with
          the same level of attention and dedication, leaving you with an immaculate environment to
          enjoy.
        </p>
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 mt-10">
          <div className="group flex">
            <div className="bg-white p-6 rounded-lg shadow-xl group-hover:bg-green flex flex-col justify-between">
              ...
              <p className="text-slate-600 group-hover:text-white text-justify">
                We understand that every home is unique. That's why we tailor our cleaning services
                to match your specific needs and preferences, ensuring a truly personalized
                experience.
              </p>
            </div>
          </div>
