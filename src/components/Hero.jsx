...
function Hero() {
  return (
    <>
      <div className="min-[600px]:bg-sky-300 ">Hey</div>
      <div className="w-full h-screen bg-zinc-200 flex flex-col justify-between ">
        <div className="grid md:grid-cols-2 max-w-[1240px] m-auto ">
          ...
          <div className=" absolute md:flex flex-col items-center py-8 lg:min-w-[1100px] md:min-w-[790px] sm:max-w-[600px] bottom-[5%] mx-1 md:left-1/2 transform md:-translate-x-1/2 md:translate-y-3/4 bg-zinc-200 border border-slate-300 rounded-xl text-center shadow-xl translate-y-[500px] hidden">
            ...
            <div className="grid md:grid-cols-2 grid-cols-1 px-4 gap-4">
              ...
              <p className="flex px-4 py-2 text-slate-600 font-semibold">
                <CheckIcon className="h-6 w-6 text-indigo-600" /> Expert Staff: Skilled cleaners
                with keen attention to detail.
              </p>

              <p className="flex px-4 py-2 text-slate-600 font-semibold">
                <CheckIcon className="h-6 w-6 text-indigo-600" /> Flexible Plans: Customized
                services to suit your schedule.
              </p>
              <p className="flex px-4 py-2 text-slate-600 font-semibold">
