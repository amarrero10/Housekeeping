...
function Pricing() {
  return (
    <div className=" w-screen px-2 mt-5 ">
      <div className="text-center ">
        <h2 className="text-2xl my-3 text-slate-800 font-bold">Transparent Pricing Plans</h2>
        <p className="text-slate-700">
          At BRAND, we believe in offering honest and transparent pricing for our cleaning services.
          Our pricing plans are designed to be affordable and cater to your specific needs. With no
          hidden fees, you can trust us to deliver exceptional service at a fair price.
        </p>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 ">
        <div className="bg-white p-6 rounded-lg shadow-xl flex flex-col justify-between mt-2 sm:mt-0 sm:max-h-[450px] sm:overflow-auto sm:relative">
          <p className="text-center text-xl font-bold text-indigo-600">Basic Cleaning</p>
          ...
          <ul className="">
            <li className="flex">
              <CheckIcon className=" absolute -ml-6 h-8 text-indigo-600" />
        ...
        <div className="bg-white p-6 rounded-lg shadow-xl flex flex-col justify-between">
          <p className="text-center font-bold text-xl text-indigo-600">Deep Cleaning</p>
          <p className=" text-center">
        ...
        <div className="bg-white p-6 rounded-lg shadow-xl flex flex-col justify-between">
          <p className="text-center text-xl font-bold text-indigo-600">A La Carte Services</p>
          <p className="text-center">
      ...
      <div>
        <p>Rates are offered at a discounted rate for recurring customers</p>
      </div>
      <div>
        <p>
